...
namespace XkbPlugin
{
    ...
    [CCode(cname="xkb_backend_xcb_set_keymap_on_window")]
    extern void set_keymap_on_window(Xkb.Context ctx,Xkb.RuleNames rule_names, Xcb.xkb.Connection conn, Xcb.Atom names_atom, Xcb.Window root);
...
//            set_keymap_on_window(ctx,keymap_rule_names,conn,xkb_names_atom,find_root_window());
            update_state();
        }
